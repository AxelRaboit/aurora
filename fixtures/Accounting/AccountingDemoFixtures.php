...
namespace Aurora\Fixtures\Accounting;
...
use Aurora\Module\Accounting\Customer\Dto\CustomerInput;
use Aurora\Module\Accounting\Customer\Entity\CustomerInterface;
use Aurora\Module\Accounting\Customer\Manager\CustomerManagerInterface;
...
/**
 * Demo content for the accounting module: three customers, three trames and a
 ...
 * run created itself.
 */
class AccountingDemoFixtures extends Fixture implements DependentFixtureInterface, FixtureGroupInterface
{
    /**
    ...
    private const array PROVIDER = [
        'accounting_provider_name' => 'Studio Aurora (demonstration)',
        'accounting_provider_representative' => 'Camille Vasseur, gerante',
        'accounting_provider_address' => '12 rue des Fabriques, 69000 Lyon',
        'accounting_provider_siret' => '83787330207491',
        'accounting_provider_ape_code' => '62.01Z (programmation informatique)',
        'accounting_provider_vat_mention' => 'TVA non applicable, article 293 B du CGI',
        'accounting_provider_email' => 'contact@studio-aurora.test',
        'accounting_provider_phone' => '04 00 00 00 00',
        'accounting_provider_bank_holder' => 'Studio Aurora',
        'accounting_provider_bank_iban' => 'FR7630001007941234567890185',
        'accounting_provider_bank_bic' => 'DEMOFRPP',
        'accounting_provider_bank_name' => 'Banque de demonstration',
    ];
