...
final class ContractPdfTest extends IntegrationTestCase
{
    ...
    public function testThePdfIsServedThroughItsOwnGatedRouteAndNotTheCatchAll(): void
    {
        ...
        $this->login();
        $this->client->request('GET', sprintf('/backend/accounting/contracts/%d/pdf', $contract->getId()));
    ...
    public function testAContractWithNoPdfAnswers404(): void
    {
        ...
        $this->login();
        $this->client->request('GET', sprintf('/backend/accounting/contracts/%d/pdf', $contractId));
    ...
    private function concludedContract(): Contract
    {
        ...
        $this->login();
        $this->client->jsonRequest('POST', sprintf('/backend/accounting/contracts/%d/countersign', $contractId), [
            'firstName' => 'Axel',
            'lastName' => 'Raboit',
    ...
    {
        $this->client->jsonRequest('POST', '/backend/accounting/contracts/create', [
        ...
        $this->client->jsonRequest('POST', sprintf('/backend/accounting/contracts/%d/freeze', $id));
        $this->client->jsonRequest('POST', sprintf('/backend/accounting/contracts/%d/send', $id));
        self::assertSame(200, $this->client->getResponse()->getStatusCode());
