...
final class ContractsControllerTest extends IntegrationTestCase
{
    ...
    public function testASealedContractRefusesEveryFurtherWrite(): void
    {
        ...
        $this->client->jsonRequest('POST', sprintf('/backend/accounting/contracts/%d/update', $id), [
        ...
        $this->client->jsonRequest('POST', sprintf('/backend/accounting/contracts/%d/delete', $id));
        self::assertSame(422, $this->client->getResponse()->getStatusCode());
    }
    ...
    public function testTheDocumentPageShowsTheSealAsIntact(): void
    {
        ...
        $this->client->request('GET', sprintf('/backend/accounting/contracts/%d', $id));
