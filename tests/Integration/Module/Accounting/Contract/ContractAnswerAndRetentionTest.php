...
use Aurora\Module\Accounting\Contract\Refusal\Dto\ContractRefusalInput;
...
final class ContractAnswerAndRetentionTest extends IntegrationTestCase
{
    ...
    {
        $this->settings->set(ApplicationParameterEnum::AccountingContractRetentionYears->value, '10');
    ...
    public function testTheRetentionNeverFallsBelowFiveYears(): void
    {
        ...
        $this->settings->set(ApplicationParameterEnum::AccountingContractRetentionYears->value, '0');
        self::assertSame(ContractRetentionPolicy::MINIMUM_YEARS, $policy->years());

        $this->settings->set(ApplicationParameterEnum::AccountingContractRetentionYears->value, '-4');
        self::assertSame(ContractRetentionPolicy::MINIMUM_YEARS, $policy->years());

        $this->settings->set(ApplicationParameterEnum::AccountingContractRetentionYears->value, '12');
    ...
    {
        $this->settings->set(ApplicationParameterEnum::AccountingContractRetentionYears->value, '5');
