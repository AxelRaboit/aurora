...
final class ContractTemplatesControllerTest extends IntegrationTestCase
{
    ...
    public function testTheWordingIsSavedThenPublishedAndThenRefusedAWrite(): void
    {
        ...
        $this->client->jsonRequest(
            'POST',
            sprintf('/backend/accounting/contract-templates/%d/versions/%d/save', $templateId, $versionId),
            ['translations' => [
        ...
        $this->client->jsonRequest(
            'POST',
            sprintf('/backend/accounting/contract-templates/%d/versions/%d/publish', $templateId, $versionId),
        );
    ...
    public function testAnEmptyDraftIsRefusedPublication(): void
    {
        ...
        $this->client->jsonRequest(
            'POST',
            sprintf(
                '/backend/accounting/contract-templates/%d/versions/%d/publish',
                $created['template']['id'],
                $created['draftId'],
            ),
        );
    ...
    public function testASecondDraftIsRefusedWithASentence(): void
    {
        ...
        $this->client->jsonRequest(
            'POST',
            sprintf('/backend/accounting/contract-templates/%d/open-draft', $created['template']['id']),
        );
    ...
    public function testAVersionOfAnotherTemplateIsNotFound(): void
    {
        ...
        $this->client->jsonRequest(
            'POST',
            sprintf(
                '/backend/accounting/contract-templates/%d/versions/%d/save',
                $first['template']['id'],
                $second['draftId'],
            ),
    ...
    public function testArchivingTakesATemplateOutOfTheSelectableSet(): void
    {
        ...
        $this->client->jsonRequest('POST', sprintf('/backend/accounting/contract-templates/%d/archive', $id));
        ...
        $this->client->jsonRequest('POST', sprintf('/backend/accounting/contract-templates/%d/restore', $id));
        self::assertSame(200, $this->client->getResponse()->getStatusCode());
    }
    ...
    public function testTheEditorPageRendersForADraft(): void
    {
        ...
        $this->client->request(
            'GET',
            sprintf(
                '/backend/accounting/contract-templates/%d/versions/%d',
                $created['template']['id'],
                $created['draftId'],
            ),
        );
    ...
    {
        $this->client->jsonRequest('POST', '/backend/accounting/contract-templates/create', [
            'name' => $name,
            'kind' => 'body',
        ]);
