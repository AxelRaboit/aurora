...
namespace Aurora\Tests\Integration\Module\Accounting\Customer;
...
final class CustomersControllerTest extends IntegrationTestCase
{
    ...
    {
        $this->client->jsonRequest('POST', '/backend/accounting/customers/create', [
    ...
    public function testTheSameSiretCannotBeRecordedTwice(): void
    {
        ...
        $this->client->jsonRequest('POST', '/backend/accounting/customers/create', $body);
        self::assertSame(200, $this->client->getResponse()->getStatusCode());
    ...
    public function testACustomerKeepsItsOwnSiretWhenEdited(): void
    {
        ...
        $this->client->jsonRequest('POST', sprintf('/backend/accounting/customers/%d/update', $id), [
