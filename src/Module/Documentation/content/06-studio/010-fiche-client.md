...
![L'identité de la société renseignée](../../images/06-studio/fiche-client-03-l-identite-legale.png)
...
![Les identifiants de la société](../../images/06-studio/fiche-client-04-les-identifiants.png)
...
![Le représentant légal et le contact](../../images/06-studio/fiche-client-05-le-representant.png)
...
![Le SIRET refusé, avec le message sous le champ](../../images/06-studio/fiche-client-06-le-siret-refuse.png)

## 6. Enregistrer

Le client apparaît dans la liste et devient choisissable à la préparation d'un contrat.

![Le client enregistré, dans la liste](../../images/06-studio/fiche-client-07-le-client-dans-la-liste.png)
