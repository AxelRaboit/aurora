...
![La page de signature, à l'ouverture du lien](../../images/06-studio/signature-cote-client-01-la-page-recue-par-le-client.png)
...
![Le document scellé et la mention d'information](../../images/06-studio/signature-cote-client-02-le-document-et-la-mention-d-information.png)
...
![Le formulaire de signature, vide](../../images/06-studio/signature-cote-client-03-le-formulaire-de-signature.png)
...
![L'identité renseignée et la signature tracée](../../images/06-studio/signature-cote-client-04-l-identite-et-la-signature.png)
...
![Le code demandé, avec l'adresse masquée](../../images/06-studio/signature-cote-client-05-le-code-demande.png)
...
![Le formulaire complet, prêt à signer](../../images/06-studio/signature-cote-client-06-pret-a-signer.png)
...
![Le contrat signé, vu par le client](../../images/06-studio/signature-cote-client-07-le-contrat-signe.png)
