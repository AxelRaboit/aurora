...
L'**adresse du compte** est l'URL sans le nom du compartiment à la fin. La console Cloudflare en affiche une avec le compartiment ajouté : la coller telle quelle le mettrait deux fois dans chaque requête, et rien ne fonctionnerait.
