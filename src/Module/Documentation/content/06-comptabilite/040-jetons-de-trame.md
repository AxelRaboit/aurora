...
- **provider.*** : votre identité, lue dans les réglages de Comptabilité. Douze jetons, dont les coordonnées bancaires.
...
![Le panneau des variables, familles client et prestataire](../../images/06-comptabilite/ecrire-une-version-02-le-texte-et-ses-jetons.png)
...
![Les jetons du contrat et le champ propre à un contrat](../../images/06-comptabilite/ecrire-une-version-03-le-bas-de-l-editeur.png)
