---
title: "Sceller"
description: "Ce que le scellement fige, la référence frappée, et ce qu'il refuse."
rubric: "Comptabilité"
---
...
![Le contrat en préparation, prêt à sceller](../../images/06-comptabilite/sceller-un-contrat-01-le-brouillon-a-sceller.png)
...
![Le menu d'actions d'un contrat en préparation](../../images/06-comptabilite/sceller-un-contrat-02-le-menu-d-actions.png)

## 3. La confirmation

Elle rappelle ce que l'opération a de définitif. C'est volontairement un pas de plus, pas un clic direct depuis la liste.

![La confirmation avant scellement](../../images/06-comptabilite/sceller-un-contrat-03-la-confirmation.png)
