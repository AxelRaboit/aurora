...
description: "Le client, les trames, le montant, la date d'effet, les blancs."
rubric: "Comptabilité"
---
...
- Le client doit exister dans Comptabilité → Clients, avec son bloc d'identité complet.
...
Comptabilité → Contrats. La liste sépare ce qui est **en préparation**, encore modifiable, de ce qui est **scellé**, définitif. Le bouton « Préparer un contrat » est en haut à droite.

![La liste des contrats, avec le bouton Préparer un contrat en haut à droite](../../images/06-comptabilite/preparer-un-contrat-01-la-liste.png)
...
![La fenêtre Nouveau contrat, vide, à son ouverture](../../images/06-comptabilite/preparer-un-contrat-02-la-fenetre-vide.png)
...
![Le client choisi dans la liste déroulante](../../images/06-comptabilite/preparer-un-contrat-03-le-client.png)
...
![Le corps et l'annexe choisis dans la fenêtre](../../images/06-comptabilite/preparer-un-contrat-04-le-corps-et-l-annexe.png)
...
![Le montant saisi, et la devise](../../images/06-comptabilite/preparer-un-contrat-05-le-montant.png)
...
![Le calendrier ouvert sur le champ de date](../../images/06-comptabilite/preparer-un-contrat-06-le-calendrier.png)
...
![La section Compléments du contrat, avec la durée et la formule](../../images/06-comptabilite/preparer-un-contrat-07-les-complements-de-la-trame.png)
...
![Le contrat apparaît dans la liste, en préparation](../../images/06-comptabilite/preparer-un-contrat-08-en-preparation.png)
