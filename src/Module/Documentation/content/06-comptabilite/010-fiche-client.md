---
title: "La fiche d'un client"
description: "L'identité complète de la société et de son signataire."
rubric: "Comptabilité"
---
...
Comptabilité → Clients. La recherche porte sur la raison sociale, le SIRET et le représentant. Le bouton « Ajouter un client » est en haut à droite.

![La liste des clients, avec le bouton Ajouter un client](../../images/06-comptabilite/fiche-client-01-la-liste.png)
...
![La fenêtre Nouveau client, vide](../../images/06-comptabilite/fiche-client-02-la-fenetre-vide.png)
...
![L'identité de la société renseignée](../../images/06-comptabilite/fiche-client-03-l-identite-legale.png)
...
![Les identifiants de la société](../../images/06-comptabilite/fiche-client-04-les-identifiants.png)
...
![Le représentant légal et le contact](../../images/06-comptabilite/fiche-client-05-le-representant.png)
...
![Le SIRET refusé, avec le message sous le champ](../../images/06-comptabilite/fiche-client-06-le-siret-refuse.png)

## 6. Enregistrer

Le client apparaît dans la liste et devient choisissable à la préparation d'un contrat.

![Le client enregistré, dans la liste](../../images/06-comptabilite/fiche-client-07-le-client-dans-la-liste.png)
