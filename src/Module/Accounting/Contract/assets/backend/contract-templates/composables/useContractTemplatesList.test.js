...
// Relative rather than aliased: the Accounting module keeps its assets under
// its sub-domains (Contract/assets, Customer/assets) instead of at the module
// root, so there is no `@accounting` alias to import through.
...
describe("useContractTemplatesList", () => {
    it("abandons a draft without leaving the list", async () => {
        request.mockResolvedValue({
            success: true,
            indexPath: "/backend/accounting/contract-templates",
