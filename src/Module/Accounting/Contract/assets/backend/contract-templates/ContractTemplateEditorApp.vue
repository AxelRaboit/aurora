    ...
    <div class="space-y-4">
        ...
        <AppMessage v-if="isPublished" variant="info">
            <span class="flex items-center gap-2">
                ...
                {{
                    t("backend.accounting.contract_templates.published_notice", {
        ...
        <div class="flex flex-wrap items-center justify-between gap-3">
            <div class="flex flex-wrap items-baseline gap-2">
                ...
                >
                    {{
                        isPublished
                            ? t("backend.accounting.contract_templates.state_published")
            ...
            <div class="flex flex-wrap items-center gap-2">
                ...
                >
                    ...
                    {{ t("backend.accounting.contract_templates.publish") }}
                </AppButton>
            </div>
        </div>
        ...
        <div class="grid gap-4 lg:grid-cols-[minmax(0,1fr)_18rem]">
                ...
                >
                    ...
                    >
                        ...
                        <span
                            ...
                            :title="t('backend.accounting.contract_templates.locale_written')"
                        />
                    </button>
                </div>
                ...
                <template v-for="locale in locales" :key="locale.code">
                    <div v-show="locale.code === activeLocale" class="space-y-3">
                        <AppInput
                            ...
                            :label="t('backend.accounting.contract_templates.document_title')"
                            :placeholder="
                                t('backend.accounting.contract_templates.document_title_placeholder')
                            "
                            :hint="t('backend.accounting.contract_templates.document_title_hint')"
                        ...
                        >
                            <AppBlockEditor
                                ...
                                :placeholder="
                                    t('backend.accounting.contract_templates.content_placeholder')
                                "
                            />
                        </div>
                    </div>
            ...
            <div class="space-y-4">
                ...
                >
                    <p class="text-xs font-medium uppercase tracking-wider text-muted">
                        {{ t("backend.accounting.contract_templates.other_versions") }}
                    </p>
                    <ul class="space-y-1">
        ...
        <AppModal
            ...
            max-width="md"
            :closeable="false"
            :title="t('backend.accounting.contract_templates.publish')"
            :icon="Check"
            v-on:close="showPublish = false"
        >
            <p class="text-sm text-primary">
                {{
                    t("backend.accounting.contract_templates.publish_confirm", {
                        number: version.number,
                    })
                }}
            </p>
            ...
            <p class="text-sm text-secondary">
                {{ t("backend.accounting.contract_templates.publish_warning") }}
            </p>
            <template #footer>
                <AppModalFooter>
