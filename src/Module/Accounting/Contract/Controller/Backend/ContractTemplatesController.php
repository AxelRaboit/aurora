...
use Aurora\Module\Accounting\Contract\View\ContractTemplatesViewBuilder;
...
#[Route('/backend/accounting/contract-templates', name: 'backend_accounting_contract_templates')]
#[IsGranted('accounting.contract_templates.view')]
class ContractTemplatesController extends AbstractController
{
    ...
    {
        return $this->render('@Accounting/backend/contract-templates/index.html.twig', $this->viewBuilder->indexView());
    }
    ...
    public function editor(ContractTemplate $template, int $versionId): Response
    {
        ...
        return $this->render(
            '@Accounting/backend/contract-templates/editor.html.twig',
    ...
    #[IsGranted('accounting.contract_templates.edit')]
    ...
    #[IsGranted('accounting.contract_templates.delete')]
    ...
    private function publishedRefusal(): JsonResponse
    {
        return $this->jsonInvalidInput([
            'version' => $this->translator->trans(
                'backend.accounting.contract_templates.errors.already_published',
            ),
        ]);
    }
}
