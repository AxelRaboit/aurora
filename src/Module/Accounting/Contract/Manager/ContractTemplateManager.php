...
class ContractTemplateManager implements ContractTemplateManagerInterface
{
    ...
    public function archive(ContractTemplateInterface $template): void
    {
        ...
        $this->auditLogger->log('accounting', 'contract_template.archived', 'ContractTemplate', $template->getId(), $this->auditPayload($template));
    }
    ...
    public function restore(ContractTemplateInterface $template): void
    {
        ...
        $this->auditLogger->log('accounting', 'contract_template.restored', 'ContractTemplate', $template->getId(), $this->auditPayload($template));
    }
    ...
    {
        $this->auditLogger->log('accounting', 'contract_template.deleted', 'ContractTemplate', $template->getId(), $this->auditPayload($template));
    ...
    public function openDraft(ContractTemplateInterface $template): ContractTemplateVersionInterface
    {
        ...
        if ($existing instanceof ContractTemplateVersionInterface) {
            throw new FieldException('draft', $this->translator->trans('backend.accounting.contract_templates.errors.draft_already_open', ['{number}' => (string) $existing->getNumber()]));
        }
        ...
        $this->auditLogger->log('accounting', 'contract_template_version.opened', 'ContractTemplateVersion', $draft->getId(), [
    ...
    public function updateDraft(ContractTemplateVersionInterface $version, ContractTemplateVersionInputInterface $input): void
    {
        ...
        $this->auditLogger->log('accounting', 'contract_template_version.updated', 'ContractTemplateVersion', $version->getId(), [
    ...
    public function publish(ContractTemplateVersionInterface $version): void
    {
        ...
        $this->auditLogger->log('accounting', 'contract_template_version.published', 'ContractTemplateVersion', $version->getId(), [
            'template' => $version->getTemplate()->getName(),
            'number' => $version->getNumber(),
    ...
    public function discardDraft(ContractTemplateVersionInterface $version): void
    {
        ...
        $this->auditLogger->log('accounting', 'contract_template_version.discarded', 'ContractTemplateVersion', $version->getId(), [
            'template' => $version->getTemplate()->getName(),
            'number' => $version->getNumber(),
        ]);
    ...
    {
        $this->auditLogger->log('accounting', 'contract_template.created', 'ContractTemplate', $template->getId(), $this->auditPayload($template));
    }

    protected function auditUpdated(ContractTemplateInterface $template): void
    {
        $this->auditLogger->log('accounting', 'contract_template.updated', 'ContractTemplate', $template->getId(), $this->auditPayload($template));
    }
