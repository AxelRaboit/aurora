...
final readonly class ContractTemplatesViewBuilder
{
    ...
    public function editorView(ContractTemplateInterface $template, ContractTemplateVersionInterface $version): array
    {
        return [
            ...
            'savePath' => $this->urlGenerator->generate('backend_accounting_contract_templates_save_draft', [
                'id' => $template->getId(),
                'versionId' => $version->getId(),
            ]),
            'publishPath' => $this->urlGenerator->generate('backend_accounting_contract_templates_publish', [
                'id' => $template->getId(),
                'versionId' => $version->getId(),
            ]),
            'discardPath' => $this->urlGenerator->generate('backend_accounting_contract_templates_discard', [
                'id' => $template->getId(),
                'versionId' => $version->getId(),
            ]),
            'indexPath' => $this->urlGenerator->generate('backend_accounting_contract_templates'),
            'editorPath' => $this->urlGenerator->generate('backend_accounting_contract_templates_editor', [
                'id' => $template->getId(),
