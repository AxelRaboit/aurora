...
class CustomerInput implements CustomerInputInterface
{
    public function __construct(
        #[Assert\NotBlank(message: 'backend.accounting.customers.errors.legal_name_required')]
        #[Assert\Length(max: 180, maxMessage: 'backend.accounting.customers.errors.legal_name_too_long')]
        ...
        #[Assert\PositiveOrZero(message: 'backend.accounting.customers.errors.share_capital_invalid')]
        ...
        #[Assert\NotBlank(message: 'backend.accounting.customers.errors.contractual_email_required')]
        #[Assert\Email(message: 'backend.accounting.customers.errors.contractual_email_invalid')]
        #[Assert\Length(max: 180)]
