...
export function useCustomersForm(
    ...
    function rulesFor(form) {
        return {
            legalName: () =>
                required(
                    t(
                        "backend.accounting.customers.errors.legal_name_required",
                    ),
                )(form.value.legalName),
            contractualEmail: () =>
                required(
                    t(
                        "backend.accounting.customers.errors.contractual_email_required",
                    ),
    ...
    const {
        ...
        onSuccess: (data) => {
            ...
            toast.success(t("backend.accounting.customers.created"));
    ...
    const {
        ...
        onSuccess: (data) => {
            ...
            toast.success(t("backend.accounting.customers.updated"));
            applyUpdatedList(data);
        },
    });
    ...
    const {
        ...
        "backend.accounting.customers.deleted",
    );
