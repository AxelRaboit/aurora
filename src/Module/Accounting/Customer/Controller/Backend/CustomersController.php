...
namespace Aurora\Module\Accounting\Customer\Controller\Backend;
...
use Aurora\Module\Accounting\Customer\Dto\CustomerInputFactoryInterface;
...
use Aurora\Module\Accounting\Customer\View\CustomersViewBuilder;
...
#[Route('/backend/accounting/customers', name: 'backend_accounting_customers')]
#[IsGranted('accounting.customers.view')]
class CustomersController extends AbstractController
{
    ...
    {
        return $this->render('@Accounting/backend/customers/index.html.twig', $this->viewBuilder->indexView());
    }

    #[Route('/create', name: '_create', methods: [HttpMethodEnum::Post->value])]
    #[IsGranted('accounting.customers.create')]
    ...
    #[IsGranted('accounting.customers.edit')]
    ...
    #[IsGranted('accounting.customers.delete')]
