...
final readonly class MarkdownNotesViewBuilder
{
    ...
    public function indexView(CoreUserInterface $user, ?int $activeId = null): array
    {
        return [
            ...
            'trashPath' => $this->urlGenerator->generate('backend_notes_markdown_trash'),
            'restorePath' => $this->urlGenerator->generate('backend_notes_markdown_restore', ['id' => '__id__']),
            'forceDeletePath' => $this->urlGenerator->generate('backend_notes_markdown_force_delete', ['id' => '__id__']),
