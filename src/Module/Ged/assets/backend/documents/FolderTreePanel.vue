            ...
            >
                ...
                <div class="mt-3 flex flex-col gap-2">
                    <label class="flex items-start gap-2 text-sm text-primary cursor-pointer">
                        ...
                        >
                        <span>
                            {{ t("backend.ged.documents.delete_folder_cascade") }}
                            <span class="block text-xs text-secondary">{{ t("backend.ged.documents.delete_folder_cascade_hint") }}</span>
                        </span>
                    </label>
                    <label class="flex items-start gap-2 text-sm text-primary cursor-pointer">
                        <input
                        ...
                        >
                        <span>
                            {{ t("backend.ged.documents.delete_folder_only") }}
                            <span class="block text-xs text-secondary">{{ t("backend.ged.documents.delete_folder_only_hint") }}</span>
                        </span>
                    </label>
                </div>
                <template #footer>
