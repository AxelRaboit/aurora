...
class ContractSignatureInput implements ContractSignatureInputInterface
{
    ...
    public function __construct(
        #[Assert\NotBlank(message: 'studio.public.sign.errors.first_name_required')]
        #[Assert\Length(max: 100)]
        public readonly string $firstName = '',
        #[Assert\NotBlank(message: 'studio.public.sign.errors.last_name_required')]
        #[Assert\Length(max: 100)]
        public readonly string $lastName = '',
        #[Assert\NotBlank(message: 'studio.public.sign.errors.email_required')]
        #[Assert\Email(message: 'studio.public.sign.errors.email_invalid')]
        #[Assert\Length(max: 180)]
        public readonly string $email = '',
        #[Assert\NotBlank(message: 'studio.public.sign.errors.place_required')]
        ...
        #[Assert\NotBlank(message: 'studio.public.sign.errors.date_required')]
        #[Assert\Regex(pattern: '/^\d{4}-\d{2}-\d{2}$/', message: 'studio.public.sign.errors.date_invalid')]
        public readonly string $date = '',
        #[Assert\NotBlank(message: 'studio.public.sign.errors.image_required')]
        #[Assert\Length(max: self::MAX_IMAGE_BYTES, maxMessage: 'studio.public.sign.errors.image_too_large')]
        #[Assert\Regex(pattern: '#^data:image/png;base64,[A-Za-z0-9+/=]+$#', message: 'studio.public.sign.errors.image_invalid')]
        ...
        #[Assert\IsTrue(message: 'studio.public.sign.errors.consent_required')]
        public readonly bool $consent = false,
        #[Assert\NotBlank(message: 'studio.public.sign.errors.code_required')]
