...
class ContractTemplateVersionInput implements ContractTemplateVersionInputInterface
{
    ...
    public function __construct(
        ...
        #[Assert\Count(min: 1, minMessage: 'backend.studio.contract_templates.errors.translations_required')]
        ...
        #[Assert\Choice(callback: [LocaleEnum::class, 'values'], message: 'backend.studio.contract_templates.errors.governing_locale_unknown')]
